...
public enum CoreSystemService {
	...
	// Reputation Manager
	REPUTATIONMANAGER_RATE_SERVICE(CommonConstants.CORE_SERVICE_REPUTATIONMANAGER_RATE, CommonConstants.REPUTATIONMANAGER_URI + CommonConstants.OP_REPUTATIONMANAGER_RATE);
